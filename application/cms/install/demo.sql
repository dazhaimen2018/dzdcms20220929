...
(1, '中文站', 'zh-cn', 'http', 'demo.dzdcms.com', '/uploads/images/logo.png', '/favicon.ico', 'default', '多站点', '多站点CMS演示站', '多站点CMS,多站点官网,多站点官方网站,DzdCMS模板,多站点模板,模块插件,开源,PHP CMS,PHP', '多站点CMS官方网站是集简单、健壮、灵活、开源几大特点的开源多站点内容管理系统,是国内开源CMS的站群系统，目前程序安装量已经非常高，很多外贸网站，集团网站、城市分站都在使用多站点CMS或基于CMS核心开发', 0, '', NULL, 0, 1, 1, 0),
(2, 'English', 'en-gb', 'http', 'demo.dzdcms.com', '/uploads/images/logo.png', '/favicon.ico', 'default', '', 'English', 'English', 'English', 0, '', NULL, 0, 2, 1, 0),
(3, '北京站', 'zh-cn', 'http', 'bj.dzdcms.com', '/uploads/images/logo.png', '/favicon.ico', 'default', '', '北京站', '北京站', '北京站', 0, '', NULL, 0, 3, 1, 0),
(4, '上海站', 'zh-cn', 'http', 'sh.dzdcms.com', '/uploads/images/logo.png', '/favicon.ico', 'default', '', '上海站', '上海站', '上海站', 0, '', NULL, 0, 4, 1, 0);
