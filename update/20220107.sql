...
CREATE TABLE `dzd_site_domain` (
`id` smallint(5) UNSIGNED NOT NULL COMMENT '自然ID',
...
ALTER TABLE `dzd_site_domain`
    ADD PRIMARY KEY (`id`);

ALTER TABLE `dzd_site_domain`
    MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自然ID';
COMMIT;